...
the string is then read back from the EEPROM and compared with the original one
  ...
  HAL_I2C_Mem_Write_IT(&hi2c1, 0xA0, 0xA, I2C_MEMADD_SIZE_16BIT, (uint8_t *)"Salman\0", strlen("Salman\0")) ;
  ...
  HAL_I2C_Mem_Read(&hi2c1, 0xA0, 0xA, I2C_MEMADD_SIZE_16BIT, (uint8_t*)rmsg, strlen("Salman\0"), HAL_MAX_DELAY);
